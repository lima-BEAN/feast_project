"""
Django settings for feastfreedom project.
...
SECRET_KEY = 'django-insecure-#&v@h(kr@s##ko#d!-(8kpo&qlxfux1wu9dnuef7)b-!^-1uh+'
...
ROOT_URLCONF = 'feastfreedom.urls'
...
WSGI_APPLICATION = 'feastfreedom.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': str(BASE_DIR / 'db.sqlite3'), # using 3.2 setup since django-admin was in django==3.2 when project started.
    }
}
