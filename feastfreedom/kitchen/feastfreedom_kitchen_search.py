...
class FeastFreedomKitchenSearch(unittest.TestCase):
    ...
    def test_search_in_feastfreedom_kitchen(self):
        driver = self.driver
        driver.get("http://127.0.0.1:8000/kitchen")
